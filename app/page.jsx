    ...
    <li>
      ...
      <section id="📚publications" className="scroll-mt-24">
        ...
        <ul className="space-y-3 list-disc list-inside">
          ...
          <li><a href="https://arxiv.org/abs/2303.05433" className="text-blue-600 hover:underline">Generalised Spinʳ Structures on Homogeneous Spaces</a>, with Marie-Amélie Lawn. (Differential Geometry and its Applications, 2025)</li>
          <li><a href="https://doi.org/10.1016/j.difgeo.2025.102291" className="text-blue-600 hover:underline">Translating Solitons in Generalised Robertson–Walker Geometries</a>, with Marie-Amélie Lawn and Miguel Ortega. (Preprint, 2022)</li>
        </ul>
      </section>
