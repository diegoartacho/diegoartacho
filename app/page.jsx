    ...
    <li>
      ...
      <section id="📚publications" className="scroll-mt-24">
        ...
        <ul className="space-y-3 list-disc list-inside">
          ...
          <li><a href="https://arxiv.org/abs/2303.05433" className="text-blue-600 hover:underline">Generalised Spinʳ Structures on Homogeneous Spaces</a>, with Marie-Amélie Lawn. (Accepted in Differential Geometry and its Applications, 2025)</li>
